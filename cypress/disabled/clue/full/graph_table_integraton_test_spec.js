...
context('Tests for graph and table integration', function(){
    describe('connect table to graph before data is entered',()=>{
        before(function(){
            addTableAndGraph();
            connectTableToGraph();
        })
        ...
        describe('normal graph interactions', function(){
            ...
            //TODO: drag and drop of image tile is not working
        ...
        describe('test non-numeric entries in table', function(){
            it('will enter non-numeric number in the table', function(){
                // tableToolTile.getTableCell().eq(5).type('g');
                // tableToolTile.getTableCell().eq(1).type(' ');
                tableToolTile.enterData(5,'g')
